...
export default function ClassesList() {
    ...
    function addClassChange(event: { target: { name: string, value: string } }): void {
        setSchClass({ ...schClass, [event.target.name]: event.target.value })
    }
                                    ...
                                    <tr key={schClass.id}>
                                        ...
                                        <th className="d-flex justify-content-around">
                                            <button className="btn btn-primary" onClick={() => {
                                                setIsEditing(true);
                                                setSelectedClass(schClass.id);
                                            }}>Edit</button>
                                            <button className="btn btn-primary">Delete</button></th>
                                    </tr>
                                )
                            })
