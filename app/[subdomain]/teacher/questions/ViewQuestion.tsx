...
const ViewQuestion = (props: any) => {
    ...
    return (
        <div className="container mt-5">
            <h2 className='d-flex justify-content-between'>{props.type} View Question <button className='btn btn-success' onClick={() => props.setView(false)}>close</button></h2><br />
