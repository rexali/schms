...
export default function AddSyllabus(props: any) {
    ...
    const updateSyllabus = async () => {
        ...
        const syllabusResponse = await fetch('/api/syllabus/' + props.syllabusId, {
            mode: 'cors',
            method: "PATCH",
    ...
    return (
        <div className="container">
            <h2 className='d-flex justify-content-between'>Edit Syllabus <button className='btn btn-success' onClick={() => props.setEdit(false)}>close</button></h2>
