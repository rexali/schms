...
export default function AddSchemeWork(props: any) {
    ...
    const updateScheme = async () => {
        ...
        const schemeResponse = await fetch('/api/schemes/' + props.schemeId, {
            mode: 'cors',
            method: "PATCH",
    ...
    return (
        <div className="container">
            <h2 className='d-flex justify-content-between'>Edit Scheme of Work <button className='btn btn-success' onClick={() => props.setEdit(false)}>close</button></h2>
