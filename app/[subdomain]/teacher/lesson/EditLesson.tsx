...
export default function EditLesson(props: any) {

    return (
        <form className='w-100 m-auto'>

            <h2 className="h3 mb-3 fw-normal bg-light p-2 d-flex flex-row justify-content-between">Edit a lesson <button className="btn btn-success" onClick={() => props.setEdit(false)}><Close /> close</button></h2>
            <div className="row">
